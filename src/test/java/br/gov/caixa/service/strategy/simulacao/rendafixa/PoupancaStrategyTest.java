...
class PoupancaStrategyTest {
    ...
    public void testCalcularValorFinalDelegado() {
        ...
        BigDecimal rentabilidade = BigDecimal.valueOf(0.005);
        int prazoMeses = 12;
        BigDecimal valorEsperado = BigDecimal.valueOf(1061.68);
    ...
    public void testCalcularRentabilidadeEfetivaDelegado() {
        ...
        BigDecimal valorFinal = BigDecimal.valueOf(2200);
        BigDecimal rentabilidadeEsperada = BigDecimal.valueOf(0.10);
